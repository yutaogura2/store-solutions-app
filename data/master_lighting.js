...
(function (root, factory) {
  ...
  return {
    ...
    /* 蛍光ランプの製造・輸出入廃止(水俣条約) — 環境省 https://www.env.go.jp/chemi/tmms/lamp.html で一次確認済み(2026-08-07) */
    regulation: {
      title: "蛍光灯の今後(水俣条約による製造・輸出入の廃止)",
      items: [
        { type: "電球形", note: "2026年1月1日から(30W超は2027年1月1日)" },
        { type: "コンパクト形", note: "2027年1月1日から" },
        { type: "直管形・環形", note: "2028年1月1日から(一部蛍光体は2027年1月1日)" }
      ],
      useNote: "今お使いの照明の使用が禁止されるものではありませんが、製造終了後は交換用ランプの入手性が下がり、調達価格の上昇が見込まれます",
      source: "環境省(2026年8月時点の公表情報)",
      verified: true
    }
  };
});
